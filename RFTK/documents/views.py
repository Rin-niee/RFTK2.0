...
def checkadd(request):
    if request.method == 'POST':
        ...
        form_org_counter = Org_infoForm(request.POST, prefix="buy")#<-сюда сохраняем данные и ссылку на контрагента
        ...
        all_forms = [
        # form_check,
        form_org_info, form_org_DL, form_org_Con, form_org,
        form_org_bank, form_org_for_bank, 
        form_buy_info, form_buy_Con, form_org_counter, form_counter,  #form_buy_bank, form_buy_for_bank,
        # form_consignee, form_cons_info, form_cons_Con, form_cons_client, form_additionally,
